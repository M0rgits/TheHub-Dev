...
var h5gms = [
  //io games
  //{ name: "", custom: "", prox: "true", img: ".png", description: "" },

  //{ name: "", path: "/", img: ".png", description: "" },
  { name: "Rocket Bot Royal", path: "/rocketbotroyal", img: "rocketbotroyal.png", description: "Rocket Bot Royale is a gravity-defying multiplayer tank game set in a battle royale arena. Blast other players, collect coins, avoid the rising water levels, and survive for longer than the rest." },
  { name: "Pokemon Showdown", custom: "play.pokemonshowdown.com", prox: "true", img: "pokemonshowdown.png", description: "Pokemon Showdown added from Game Request!" },
